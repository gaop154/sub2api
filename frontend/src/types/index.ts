...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'grok_search' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'grok_search' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax'
