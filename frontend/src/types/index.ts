...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'grok_search' | 'kimi' | 'zhipu' | 'deepseek' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'grok_search' | 'kimi' | 'zhipu' | 'deepseek'
