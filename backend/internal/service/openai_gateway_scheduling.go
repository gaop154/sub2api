...
// NormalizeOpenAICompatiblePlatform 保留 grok、grok_search 与国产 OpenAI 兼容供应商
// （kimi/zhipu/deepseek）的原值，其他值一律归一为 openai。调度器据此对账号与请求做
...
func NormalizeOpenAICompatiblePlatform(platform string) string {
	switch platform {
	case PlatformGrok, PlatformGrokSearch, PlatformKimi, PlatformZhipu, PlatformDeepseek, PlatformMiniMax, PlatformOpenCodeGo:
		return platform
	default:
